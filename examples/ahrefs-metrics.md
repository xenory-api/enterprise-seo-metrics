# Ahrefs Metrics API Examples

Code examples for integrating with the **Ahrefs Metrics** endpoint using different programming languages, HTTP clients, and request libraries. These examples demonstrate how to authenticate requests, send parameters, and process API responses.
...
This document provides example requests for the **Ahrefs Metrics** endpoint.
...
```
POST https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics
```
...
curl_easy_setopt(hnd, CURLOPT_URL, "https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics");
...
(client/post "https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics" {:headers {:x-rapidapi-key "YOUR_API_KEY"
...
var request = new HttpRequestMessage
{
	...
	RequestUri = new Uri("https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics"),
	Headers =
	{
...
```csharp
var client = new RestClient("https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics");
...
client.prepare("POST", "https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics")
...
HttpRequest request = HttpRequest.newBuilder()
		.uri(URI.create("https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics"))
...
```java
HttpResponse<String> response = Unirest.post("https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics")
	.header("x-rapidapi-key", "YOUR_API_KEY")
	.header("x-rapidapi-host", "enterprise-seo-metrics.p.rapidapi.com")
	.header("Content-Type", "application/x-www-form-urlencoded")
	.body("url=google.com")
...
xhr.open('POST', 'https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics');
...
```javascript
const url = 'https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics';
const options = {
	method: 'POST',
	headers: {
		'x-rapidapi-key': 'YOUR_API_KEY',
...
const req = unirest('POST', 'https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics');
...
NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:[NSURL URLWithString:@"https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics"]
...
let uri = Uri.of_string "https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics" in
...
curl_setopt_array($curl, [
	CURLOPT_URL => "https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics",
...
$response = $client->request('POST', 'https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics', [
	'form_params' => [
		'url' => 'google.com'
	],
	'headers' => [
...
$request->setUrl('https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics');
...
$request->setRequestUrl('https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics');
...
$response = Invoke-WebRequest -Uri 'https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics' -Method POST -Headers $headers -ContentType 'application/x-www-form-urlencoded' -Body 'url=google.com'
```
...
$headers.Add("x-rapidapi-host", "enterprise-seo-metrics.p.rapidapi.com")
$headers.Add("Content-Type", "application/x-www-form-urlencoded")
$response = Invoke-RestMethod -Uri 'https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics' -Method POST -Headers $headers -ContentType 'application/x-www-form-urlencoded' -Body 'url=google.com'
```
...
conn.request("POST", "/ahrefs-metrics", payload, headers)
...
url = URI("https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics")
...
```shell
http --form POST https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics \
	Content-Type:application/x-www-form-urlencoded \
	x-rapidapi-host:enterprise-seo-metrics.p.rapidapi.com \
	x-rapidapi-key:YOUR_API_KEY \
	url=google.com
...
wget --quiet \
	...
	--output-document \
	- https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics
```
...
let request = NSMutableURLRequest(url: NSURL(string: "https://enterprise-seo-metrics.p.rapidapi.com/ahrefs-metrics")! as URL,
